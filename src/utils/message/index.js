...
export default class MessageUtil {
  @swallow
  static async sendMessage(masterId, authorId, targetId, commentId, target, type) {
 ...
 */
  @swallow
  static async sendMessageToMentionUsers(text, authorId, targetId, commentId, target, type){
